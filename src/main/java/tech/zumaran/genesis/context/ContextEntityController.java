...
public abstract class ContextEntityController<Context extends GenesisContext, Entity extends ContextEntity<Context>> {

	@Autowired
	protected ContextEntityService<Context, Entity> service;
